    ...
    <Container className="my-5 d-flex justify-content-center">
      <Card className="shadow-lg border-0 p-3" style={{ maxWidth: '600px' }}>
        ...
        <Card.Body className="text-center">
          <Texto variant="h2" className="mb-3">
            {calzado.titulo}
          </Texto>
          <Texto variant="p" className="text-muted mb-3">
            {calzado.descripcion}
          </Texto>
          <Texto variant="h4" className="mb-4 text-success">
            ${calzado.precio}
          </Texto>

          <Boton variant="success" onClick={handleAgregar}>
            Añadir al carrito
          </Boton>
        </Card.Body>
      </Card>
